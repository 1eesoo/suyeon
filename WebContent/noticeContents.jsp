...
if(request.getParameter("no")!=null){
	...
	if(no!=0){
	 snb = (SemiNoticeBean)AppleDao.noticeInfo(no);	
	}
   ...
   <header class="main_menu">
                ...
                <div class="row align-items-center ">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            <a class="navbar-brand" href="index.html"> <img src="/semicolonweb/img/semi_logo.png" alt="logo" width="200" height="80"> </a>
    ...
    <div class="contents">
    	<div class="btnGroup">
    		...
    		<button class="back"><a id="aback" href="community.jsp?type=notice&no=<%=no %>&page=<%=pageData%>">목록</a></button>
    		<% if(snb.getId().equals(id)||id.equals("admin")){ %>
    		<button class="mod"><a id="aedit" href="noticeForm.jsp?type=notice&mode=modify&page=<%=pageData %>&no=<%=no%>">수정</a></button>
    		<button class="del"><a id="adelete" href="delete.jsp?type=notice&no=<%=no %>">삭제</a></button>
    		<%} %>
    	</div>
    	</div>
    	<div>
