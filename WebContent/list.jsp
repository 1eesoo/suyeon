...
font-family: inherit;
background: url('/semicolonweb/semiupload/arrow.jpg') no-repeat 95% 50%;
border-radius: 0px;
...
<body>
	...
	<section class="hotel_list section_padding single_page_hotel_list">
			...
			<div class="row" >
				...
				<div class="col-lg-4 col-sm-6" style="">
					...
					<div class="single_ihotel_list">
						<!-- 개별상품 -->
						<img
							src="/semicolonweb/semiupload/<%=pList!=null?pList.get(i).getPfilename():""%>"
							alt="<%=pList.get(i).getPfilename()%>" width=300 height=300>
						
						<div class="hotel_text_iner">
							<h3>
								<a href="/semicolonweb/info.jsp?id=<%=id %>&pno=<%=pList.get(i).getPno()%>"> <%=pList.get(i).getPname()%></a>
							</h3>
		...
		<div id="floatMenu" class="col-lg-4 col-sm-6" style="float:right;display:inline-block">
				...
				%>
					...
					<img src="/semicolonweb/semiupload/<%=list.get(0).getPfilename() %>" alt="<%=list.get(0).getPfilename() %>"/>
				<%
					}
				}
				%>  성수 나중에 수정 할 예정   --%>
              ...
              <li>예약 TOP1</li>
              <li><%=bean.getPname() %></li>
              <img src="/semicolonweb/semiupload/<%=bean.getPfilename() %>"/>
	...
	<!-- footer part end-->
<a style="display:scroll;position:fixed;bottom:40px;right:10px; width:50px; height:50px" href="#" title=”맨위로"><img src="/semicolonweb/semiupload/img_top.png"></a>
