...
<%@page import="sist.com.dao.MyPageDao"%>
...
<script	src="https://code.jquery.com/jquery-3.5.0.min.js"></script>
 <script src="/semicolonweb/js/myPage.js" charset="UTF-8"></script>
				...
				<div class="row align-items-center ">
					<div class="col-lg-12">
						<nav
							...
							<a class="navbar-brand" href="index.jsp?id=<%=id%>"> <img
...
<nav class="navbar navbar-expand-sm bg-light navbar-light" id="navbar">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="myReservation.jsp?id=<%=id%>">예약내역</a>
    </li>
  </ul>
</nav>
	...
	<form id="myInfo" action="myInfoProcess.jsp?id=<%=id %>" method="post">
