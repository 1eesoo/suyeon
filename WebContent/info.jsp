...
<html>
    ...
    <link href="dist/css/datepicker.min.css" rel="stylesheet" type="text/css">
      ...
      <%
		...
		/* Review */
		ArrayList<SemiReviewBean>list=null;
		list=(ArrayList<SemiReviewBean>)SuyeonSemiDao.selectReview();
                  ...
                  <div class="col-lg-6 col-sm-12 col-md-6">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6">
                        <div class="sub_menu_right_content">
                            ...
                            <%if(id.equals("admin")){ %>
                            <a href="admincontrolMain.jsp?id=<%=id%>">관리자페이지</a>
                            <%
                            }
                            %>
                             <%
                ...
                <div class="row align-items-center ">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            <a class="navbar-brand" href="/semicolonweb/index.jsp?id=<%=id%>"> <img src="/semicolonweb/img/semi_logo.png" alt="logo" width="200" height="80"> </a>
		        	...
		        	<div id="reserve_contents">
		        		<h5>예약하기</h5><br>
		                      ...
		                      <!-- 달력 시작 -->              
					            ...
					            <a href="info.jsp?page=<%=currentPage + 1%>&id=<%=id%>&pno=<%=pno1%>">Next</a>
					            <%
					            }else if(currentPage>1&&currentPage<5){
					            %>
					            <a href="info.jsp?page=<%=currentPage - 1%>&id=<%=id%>&pno=<%=pno1%>">Before</a>
					            <a id="monthid"><%=y%>년<%=(m+1)%>월</a> 달력
					            <a href="info.jsp?page=<%=currentPage + 1%>&id=<%=id%>&pno=<%=pno1%>">Next</a>
					            <%
    ...
    <section id="productReview">
    	<div id="review">
	    	...
	    	<%
				...
				list2=(ArrayList<SemiReviewBean>)SuyeonSemiDao.selectReview();
			...
			%>
		    		...
		    		<div id="reviewUl">
		    			...
		    			<ul class="reviewUl3">
		    				...
		    				<li class="reviewImage">
		    					<img src="/semicolonweb/semiupload/<%=bean.getRvfilename()%>" >	    					
		    				</li>
	    		...
	    		<div id="frmDiv">
	    			...
	    			<form action="registerReview.jsp?pno=<%=pno%>&cno=<%=cno %>&id=<%=rvid %>" id="reviewFrm" name="reviewFrm" method="post" enctype="multipart/form-data">
	    				<table>
	    					<tr>
	    						<td>
	    							<ul class="reviewUl1">
