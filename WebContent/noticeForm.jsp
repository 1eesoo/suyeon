...
// 		String pageData="1";
		...
		SemiNoticeBean snb = null;
 		if(mode!=null&& mode.equals("modify")){
 			...
 			snb = (SemiNoticeBean)AppleDao.noticeInfo(Integer.parseInt(no));
...
<body>
   ...
   <header class="main_menu">
    ...
    <div id="qnaRegi">
    	<h1 align="center" style="font-weight: bold; size: 50px; margin-top: 50px;">공지사항등록</h1>
    	<form action="insert.jsp?mode=<%=mode %>&type=notice&page=<%=pageData%>" name="noticeFrm" method="POST" enctype="multipart/form-data">
    		<table>
    			...
    			<tr>
    				...
    				<td>
    					<input type="text" name="title" size="93" value="<%=snb!=null?snb.getNtitle():""%>">
    				</td>
    			</tr>
    			<tr>
    				<td>
    				...
    				<td>
    					<textarea id="txtarea" name="contents"><%=snb!=null?snb.getNcontents():""%></textarea>
    				</td>
    			</tr>
				    	...
				    	<input type="hidden" name="no" value="<%=snb!=null?snb.getNno():"" %>">
    		<div id="btnDiv">
