...
<%@page import="sist.com.dao.AddressDao"%>
...
<%
  ...
  //out.println(dong);
  List<zipBean>list = dong!=null?AddressDao.selectDong(dong):null;
...
<body>
	...
	<form action="" name="searchFrm" method="post">
		<table width="400" height="380" border="0" cellpadding="0"
			cellspacing="0">
			<tr>
				<td valign="top" background="/semicolonweb/sist/img/join_pop_bg1.gif">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td height="45" colspan="3"><img
								src="/semicolonweb/sist/img/join_pop_title4.gif" width="115" height="20"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height="40" align="center" bgcolor="F5F5F5">주소검색 <input
								name="dong" id="dong" type="text" size="25" class="input"> <input id="searchDong"
									type="image" src="/semicolonweb/sist/img/btn_search.gif" width="36"
