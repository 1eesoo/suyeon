...
<script src="/semicolonweb/js/register.js" charset="UTF-8"></script>
...
<body>
   ...
   <header class="main_menu">
                            ...
                            <div class="collapse navbar-collapse main-menu-item justify-content-center"
                                ...
                                <ul class="navbar-nav">
                                   ...
                                   <!--  <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="admincontrolMain.jsp?id=<%=id %>">관리자페이지</a>
                                    </li>                          
                                </ul>
                            </div>
	...
	<div id="registerProPart">
		...
		<form action="registerProcess.jsp?type=product&id=<%=id %>" name="rcfrm" method="POST" enctype="multipart/form-data">
			<table>
				<tr>
